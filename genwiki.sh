...
python /notebooks/scripts/wikitop25tts.py > /notebooks/inputs/wikitop25.txt
/notebooks/tortoise-tts/read.py --voice william --preset fast --output_path=/notebooks/outputs/wikitop25 --text-file=/notebooks/jm/jm-inputs/wikitop25.txt  2>&1 | tee -a /notebooks/jm/jm-logs/wiki25log.txt
